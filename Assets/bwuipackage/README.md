...
<root>
  ...
  ├── Editor
  │   ├── Bigwan.Bwuipackage.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Bigwan.Bwuipackage.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Bigwan.Bwuipackage.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Bigwan.Bwuipackage.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Bigwan.Bwuipackage`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package BwUIPackage Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Bigwan.Bwuipackage.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Bigwan.Bwuipackage.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Bigwan.Bwuipackage.Editor.Tests.asmdef`

  `Tests/Runtime/Bigwan.Bwuipackage.Tests.asmdef`
...
Use the `Documentations~/BwUIPackage.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
